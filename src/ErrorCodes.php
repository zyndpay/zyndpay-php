...
final class ErrorCodes
{
    ...
    public const PROMO_CODE_INACTIVE = 'PROMO_CODE_INACTIVE';
    public const PROMO_CODE_EXPIRED = 'PROMO_CODE_EXPIRED';
    public const PROMO_CODE_USAGE_LIMIT_REACHED = 'PROMO_CODE_USAGE_LIMIT_REACHED';
